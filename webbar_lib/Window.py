...
# This class is meant to be subclassed by WebbarWindow.  It provides
...
class Window(gtk.Window):
    ...
    def __new__(cls):
        ...
        Returns a fully instantiated BaseWebbarWindow object.
        """
        builder = get_builder('WebbarWindow')
        new_object = builder.get_object("webbar_window")
    ...
    def finish_initializing(self, builder):
        ...
        and creating a WebbarWindow object with it in order to finish
        initializing the start of the new WebbarWindow instance.
        """
        ...
        try:
            ...
            LaunchpadIntegration.set_sourcepackagename('webbar')
        except ImportError:
            pass
    ...
    def on_mnu_about_activate(self, widget, data=None):
        """Display the about box for webbar."""
    ...
    def on_mnu_preferences_activate(self, widget, data=None):
        """Display the preferences window for webbar."""
        ...
        if self.preferences_dialog is not None:
            ...
            self.preferences_dialog.set_core_instance(self.core_instance)
            self.preferences_dialog.show()
        # destroy command moved into dialog to allow for a help button

    def on_mnu_close_activate(self, widget, data=None):
        """Signal handler for closing the WebbarWindow."""
        self.destroy()

    def on_destroy(self, widget, data=None):
        """Called when the WebbarWindow is closed."""
